...
<head>
    ...
    <script type="text/javascript">
        ...
        function printContent(id){
            ...
            newwin.document.write('<TITLE>Dashboard GraphC503</TITLE>\n')
    ...
    <div class="tab">
        <form action="/action_page.php" style="background: transparent">
            <select name="cars" class="select" onchange="javascript:handleSelect(this)">
                <option value="GraphC503" selected>C - 503</option>
        ...
        <button><a href="../Table/TableC503.php" style="color: white">Table</a></button>
