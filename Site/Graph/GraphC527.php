...
<head>
    ...
    <script type="text/javascript">
        ...
        function printContent(id){
            ...
            newwin.document.write('<TITLE>Dashboard GraphC527</TITLE>\n')
    ...
    <div class="tab">
        <form action="/action_page.php" style="background: transparent">
            <select name="cars" class="select" onchange="javascript:handleSelect(this)">
                ...
                <option value="GraphC527" selected>C - 527</option>
            </select>
            <br><br>
        ...
        <button><a href="../Table/TableC527.php" style="color: white">Table</a></button>
