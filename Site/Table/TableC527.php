...
<head>
    <title>Dashboard TableC527</title>
    ...
    <script type="text/javascript">
        ...
        function printContent(id){
            ...
            newwin.document.write('<TITLE>Dashboard TableC527</TITLE>\n')
    ...
    <div class="tab">
        <form action="/action_page.php">
            <select name="cars" class="select" onchange="javascript:handleSelect(this)">
                ...
                <option value="TableC527" selected>C - 527</a></option>
            </select>
            <br><br>
        </form>
        <button>
        ...
        <button><a href="../Graph/GraphC527.php" style="color: white">Graph</a></button>
